    ...
    <div 
      ...
      <div
        className={`rounded-md text-sm transition-colors ${
          value 
            ? `px-2 py-0.5 ${getClasses(value)} hover:opacity-80` 
              ...
              <div className="">
                <div className="bg-gray-100 dark:bg-[#2c2c2c] p-2 py-1 min-h-[28px] cursor-text">
                  <div className="flex flex-wrap items-center gap-2">
                    {value && (
                      <div className={`inline-flex items-center px-3 py-0.5 rounded-full text-sm border bg-gray-300 text-gray-800 border-gray-200 dark:bg-[#242424] dark:text-gray-200 dark:border-[#343434]`}>
                        <span>{value}</span>
                      </div>
                    )}
                    ...
                    filteredOptions.map((option, index) => {
                      ...
                      return (
                        <div
                          ...
                          className={`w-full px-2 py-1 flex items-center gap-2 text-left transition-colors cursor-pointer rounded-md ${
                            isHighlighted 
                              ? "bg-gray-100 dark:bg-[#2c2c2c]" 
                              : "hover:bg-gray-100 dark:hover:bg-[#2c2c2c]"
                          }`}
                        >
                          <span className={`px-2 py-0.5 rounded-full text-sm ${getClasses(option.name)}`}>
                            {option.name}
                          </span>
                        </div>
                      );
